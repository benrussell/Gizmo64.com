Scanning api headers in folder: /Users/br/Desktop/GizmoVMSharedDev/Gizmo/plugin_source/gizmo_lua_api/
...
event = {}
function event.register( string_event_name, string_callback_function_name ) end
function event.unregister( string_event_name, string_callback_function_name ) end
...
font = {}
function font.drawString( font_id, string_to_draw, OPT_x,OPT_y ) end
...
function gizmo.disable( "filename" ) end
function gizmo.dofile( "filename" ) end
...
function nav.getNextNavAid( nav_ref ) end
...
timer = {}
function timer.destroy( timer_id ) end
function timer.getHPT() end
...
function utils.setClipboardText( text_chunk ) end
...
*** WARNINGS ****
Missing dox: Calls X-Plane SDK function to register dataref appropriately.
Missing dox: acf.getP()
Missing dox: acf.getP_dot()
Missing dox: acf.getQ()
Missing dox: acf.getQ_dot()
Missing dox: acf.getR()
Missing dox: acf.getR_dot()
Missing dox: debug.read_me()
Missing dox: gui.hideWidget( gui_widget_id )
Missing dox: gui.hideWindow( gui_window_id )
Missing dox: gui.setWindowCaption( gui_window_id, "My Window Caption" )
Missing dox: gui.setWindowSize( gui_window_id, left, top, width, height )
Missing dox: particles.setBirthRate( particle_emitter_id, particles_per_second )
Missing dox: particles.setCount( particle_emitter_id, max_particle_count )
Missing dox: particles.setDisabled( particle_emitter_id )
Missing dox: particles.setEnabled( particle_emitter_id )
Missing dox: particles.setEnergyMax( particle_emitter_id, emax )
Missing dox: particles.setHardDeck( particle_emitter_id, deck_altitude )
Missing dox: particles.setOrigin( particle_emitter_id, x,y,z )
Missing dox: particles.setOriginOffset( particle_emitter_id, off_x,off_y,off_z )
Missing dox: particles.setStreamHeading( particle_emitter_id, value )
Missing dox: particles.setStreamNoise( particle_emitter_id, value )
Missing dox: particles.setStreamPitch( particle_emitter_id, value )
Missing dox: particles.setStuckToAcf( particle_emitter_id, sticky )
Missing dox: particles.setTexture( particle_emitter_id, texture_id )
Missing dox: particles.setType_Cubic( particle_emitter_id )
Missing dox: particles.setType_Spherical( particle_emitter_id )
Missing dox: particles.setType_Stream( particle_emitter_id )
Missing dox: sound.getControl()
Missing dox: sound.releaseControl()
Missing dox: table.read_me()
